...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2018, Month.MAY, 30, 10, 0), "Завтрак", 200, 1),
            new Meal(LocalDateTime.of(2018, Month.MAY, 30, 13, 0), "Обед", 1200, 1),
            new Meal(LocalDateTime.of(2018, Month.MAY, 30, 20, 0), "Ужин", 700, 1),
            new Meal(LocalDateTime.of(2018, Month.MAY, 31, 10, 0), "Завтрак", 1200, 1),
            new Meal(LocalDateTime.of(2018, Month.MAY, 31, 13, 0), "Обед", 700, 1),
            new Meal(LocalDateTime.of(2018, Month.MAY, 31, 20, 0), "Ужин", 100, 1)
    );
