...
<section>
    ...
    <spring:url value="meals/save" var="save" scope="page"/>
    <spring:url value="meals/delete" var="delete" scope="page"/>
    <form method="post">
        <dl>
    ...
    <hr/>
    <a href="${save}"><spring:message code="meal.addMeal"/></a>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExceed="${meal.exceed}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${save}?id=${meal.id}"><spring:message code="meal.update"/></a></td>
