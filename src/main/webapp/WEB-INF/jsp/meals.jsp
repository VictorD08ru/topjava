...
<section>
    ...
    <spring:url value="meals/create" var="create" scope="page"/>
    <spring:url value="meals/update" var="update" scope="page"/>
    ...
    <hr/>
    <a href="${create}"><spring:message code="meal.addMeal"/></a>
    <hr/>
