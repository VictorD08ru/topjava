    ...
    <div class="container">
        ...
        <form id="mealFilter">
            <div class="form-group">
                ...
                <input type="date" class="form-control col-md-3" id="startDate" name="startDate"
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control col-md-3" id="endDate" name="endDate"
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control col-md-2" id="startTime" name="startTime"
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control col-md-2" id="endTime" name="endTime"
        ...
        <span class="form-group">
            <button type="reset" class="btn btn-primary" onclick="clearFilterForm()">
